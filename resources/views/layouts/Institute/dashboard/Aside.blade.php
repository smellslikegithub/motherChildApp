        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{url::to('/institute/register-mother')}}"><i class="fa fa-circle-o"></i>Register Mother</a></li>
                <li><a href="{{url::to('/institute/mothers-info')}}"><i class="fa fa-circle-o"></i> Show Mothers' Info</a></li>
              </ul>
            </li>
